...
/*****************************************************************************/
/*  Name: netal_android.c                                                    */
/*                                                                           */
/*  Created on: 1 avril 2016                                                 */
/*      Author: braby                                                        */
/*****************************************************************************/
/* Description: porting layer for network in Android                         */
/*****************************************************************************/

#ifdef __ANDROID__

#include "..\..\csl.h"
#include "netal_Android.h"

/******************************************************************************/
/* Name :  e_Result cl_NetwResetAndroid( t_Reader *pReader );                       */
...
/******************************************************************************/
e_Result cl_NetwResetAndroid(  t_Reader *pReader )
{
	return ( CL_OK );
}

/******************************************************************************/
/* Name :  e_Result cl_NetwRegisterAndroid( t_Reader *pReader );                    */
...
/*  TIMEOUT_ERR,              :  Overrun on timing                             */
/******************************************************************************/
e_Result cl_NetwRegisterAndroid(  t_Reader *pReader )
{
	return ( CL_OK );
}
...
/******************************************************************************/
/* Name :  e_Result cl_NetwUnregisterAndroid( t_Reader *pReader );                  */
...
/*  TIMEOUT_ERR,              :  Overrun on timing                             */
/******************************************************************************/
e_Result cl_NetwUnregisterAndroid(  t_Reader *pReader )
{
	return ( CL_OK );
}
...
/******************************************************************************/
/* Name :  e_Result cl_NetwSendDataAndroid( t_Reader *pReader, t_Buffer *ptBuff);   */
...
/******************************************************************************/
e_Result cl_NetwSendDataAndroid( t_Reader *pReader, t_Buffer *ptBuff)
{
	return ( CL_OK );
}
...
/******************************************************************************/
/* Name :  e_Result cl_NetwGetDataAndroid( t_Reader *pReader, , t_Tuple **pptTuple);  */
...
/*                          reader is already ongoing                         */
/******************************************************************************/
e_Result cl_NetwGetDataAndroid(  t_Reader *pReader, t_Tuple **pptTuple  )
{
	return ( CL_OK );
}
...
/******************************************************************************/
/* Name :  e_Result cl_NetwGetDNSTableAndroid(  t_Reader **pptReaderList );         */
...
/*  TIMEOUT_ERR,              :  Overrun on timing                             */
/******************************************************************************/
e_Result cl_NetwGetDNSTableAndroid( t_Reader **pptReaderList)
{
	return ( CL_OK );
}
